...
class GameOver(game: SpaceInvadersGame) : SuperScreen(game) {
    ...
    override fun show() {
        ...
        this.scoreFont.data.scaleX = Constants.GO_SCORE_X_SCALE
        this.scoreFont.data.scaleY = Constants.GO_SCORE_Y_SCALE
    ...
    override fun render(delta: Float) {
        ...
        this.font.draw(game.getSpriteBatch(), Constants.GAME_OVER_TEXT, Constants.GAME_OVER_TEXT_X, Constants.GAME_OVER_TEXT_Y)
